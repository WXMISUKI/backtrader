...
def _infer_category(tool_name: str) -> str:
    """根据工具名推断分类。"""
    if tool_name in {"plan_collaboration", "execute_workflow", "list_workflow_templates", "get_workflow_template_stats", "list_project_capabilities", "answer_decision_request", "get_decision_session_stats", "get_decision_feedback_insights"}:
        return "workflow"
