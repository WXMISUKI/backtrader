...
## Phase 88: 自动回归门禁默认化与修复闭环 (当前)

**SDD规格文档**: `specs/SDD_PHASE88_AUTOMATED_REGRESSION_GATE_DEFAULTING.md` ✅ 已完成

| # | 任务 | 优先级 | 状态 | 负责 | 备注 |
|---|------|--------|------|------|------|
| 88.0 | 编写 SDD 规格文档 | P0 | ✅ | - | SDD_PHASE88_AUTOMATED_REGRESSION_GATE_DEFAULTING.md |
| 88.1 | 默认化 regression_gate 视图 | P0 | ✅ | - | build_regression_gate |
| 88.2 | 在 daily_run 中写入回归门禁 | P0 | ✅ | - | run_status |
| 88.3 | 在 acceptance 中检查回归门禁 | P0 | ✅ | - | 可验字段 |
| 88.4 | 在 baseline 中突出回归门禁 | P0 | ✅ | - | 第一眼可见 |
| 88.5 | 编写回归测试 | P1 | ⬜ | - | 默认读取与回写 |
| 88.6 | 编写归档文档 | P1 | ✅ | - | ARCHIVE_PHASE88_AUTOMATED_REGRESSION_GATE_DEFAULTING.md |
| 88.7 | 更新路线图与任务清单 | P1 | ✅ | - | 已更新 |

## Phase 89: 日常使用测试规范化与最小对话入口说明 (当前)

**SDD规格文档**: `specs/SDD_PHASE89_DAILY_USAGE_TESTING_AND_ENTRY.md` ✅ 已完成

| # | 任务 | 优先级 | 状态 | 负责 | 备注 |
|---|------|--------|------|------|------|
| 89.0 | 编写 SDD 规格文档 | P0 | ✅ | - | SDD_PHASE89_DAILY_USAGE_TESTING_AND_ENTRY.md |
| 89.1 | 固化日常使用测试顺序 | P0 | ✅ | - | README / usage guide |
| 89.2 | 明确最小使用入口 | P0 | ✅ | - | CLI / HTTP API / 日常脚本 |
| 89.3 | 明确前端对话入口现状 | P0 | ✅ | - | 无独立 Web UI |
| 89.4 | 将使用说明写入 README_QUANT | P0 | ✅ | - | 已完成 |
| 89.5 | 补最小验证步骤 | P1 | ⬜ | - | 待执行 |
| 89.6 | 编写归档文档 | P1 | ✅ | - | ARCHIVE_PHASE89_DAILY_USAGE_TESTING_AND_ENTRY.md |
| 89.7 | 更新路线图与任务清单 | P1 | ✅ | - | 已更新 |

## Phase 90: 对话式入口产品化与最小聊天壳 (当前)

**SDD规格文档**: `specs/SDD_PHASE90_CONVERSATIONAL_ENTRY_PRODUCTIZATION.md` ✅ 已完成

| # | 任务 | 优先级 | 状态 | 负责 | 备注 |
|---|------|--------|------|------|------|
| 90.0 | 编写 SDD 规格文档 | P0 | ✅ | - | SDD_PHASE90_CONVERSATIONAL_ENTRY_PRODUCTIZATION.md |
| 90.1 | 定义统一对话协议 | P0 | ⬜ | - | 请求 / 响应 / 工具轨迹 |
| 90.2 | 实现最小 CLI 对话壳 | P0 | ⬜ | - | 持续会话式交互 |
| 90.3 | 收口 HTTP 对话入口 | P0 | ⬜ | - | 统一 API 语义 |
...
**SDD规格文档**: `specs/SDD_PHASE84_PRODUCTION_ARTIFACT_CONTRACT.md` ✅ 已完成

| # | 任务 | 优先级 | 状态 | 负责 | 备注 |
|---|------|--------|------|------|------|
| 84.0 | 编写 SDD 规格文档 | P0 | ✅ | - | `specs/SDD_PHASE84_PRODUCTION_ARTIFACT_CONTRACT.md` |
...
| 84.4 | 补最小测试 | P1 | ⬜ | - | 字段存在/缺失两种场景 |
| 84.5 | 编写归档文档 | P1 | ✅ | - | `specs/ARCHIVE_PHASE84_PRODUCTION_ARTIFACT_CONTRACT.md` |
...
**SDD规格文档**: `specs/SDD_PHASE85_DATA_CONFIDENCE_AND_PROVIDER_VISIBILITY.md` ✅ 已完成

| # | 任务 | 优先级 | 状态 | 负责 | 备注 |
|---|------|--------|------|------|------|
| 85.0 | 编写 SDD 规格文档 | P0 | ✅ | - | `specs/SDD_PHASE85_DATA_CONFIDENCE_AND_PROVIDER_VISIBILITY.md` |
...
| 85.5 | 保持门禁语义不变 | P0 | ✅ | - | 不改主链路 |
| 85.6 | 补最小回归测试 | P1 | ⬜ | - | 主源 / 备源 / 兜底 |
| 85.7 | 编写归档文档 | P1 | ✅ | - | `specs/ARCHIVE_PHASE85_DATA_CONFIDENCE_AND_PROVIDER_VISIBILITY.md` |
...
**SDD规格文档**: `specs/SDD_PHASE86_QUANT_ENV_GATING.md` ✅ 已完成

| # | 任务 | 优先级 | 状态 | 负责 | 备注 |
|---|------|--------|------|------|------|
| 86.0 | 编写 SDD 规格文档 | P0 | ✅ | - | `specs/SDD_PHASE86_QUANT_ENV_GATING.md` |
...
| 86.7 | 编写归档文档 | P1 | ✅ | - | `specs/ARCHIVE_PHASE86_QUANT_ENV_GATING.md` |
...
| 89.4 | 更新 README_QUANT 使用说明 | P0 | ✅ | - | 用户直接可用 |
| 89.5 | 补最小验证步骤 | P1 | ✅ | - | 轻量验证即可 |
| 89.6 | 编写归档文档 | P1 | ✅ | - | 记录使用协议收口 |
| 89.7 | 更新路线图与任务清单 | P1 | ✅ | - | 固化口径 |
